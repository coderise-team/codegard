...
PROBLEMS_DATA = [
    ...
    },
    {
        ...
        "You must mutate the input array in-place with "
        "$O(1)$ extra memory. "
    ...
    },
    {
        ...
        "return a string array answer where answer[i] "
        "is Fizz/Buzz/FizzBuzz "
    ...
    },
    {
        "title": "Pow(x, n)",
        "slug": "powx-n",
        "description": "Implement pow(x, n), which calculates "
        "x raised to the power n (i.e., x^n).",
        "difficulty": "medium",
        "topic": "math",
        "test_cases": [
    ...
    },
    {
        ...
        "test_cases": [
            ...
            {
                "input": '"  multi   space  test "',
                "output": '"test space multi"',
                "is_visible": False,
            },
        ],
    },
    {
        ...
        "description": "Given two sorted arrays nums1 and nums2 of size "
    ...
    },
    {
        ...
        "description": "Given an array of points where points[i] = [xi, yi]"
        "represents a point on the 2D plane, "
        "return the maximum number of points that lie "
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS("Successfully seeded 15 problems and test cases!")
        )
